...
//Até o java 7 a condição podia ser um byte, short, int, char ou Enum
//com o java 7 em em diante a condição passa a receber strings também

public class SwitchCase {
    public static void main(String[] args) {
        Scanner scan = new Scanner(System.in);

        System.out.println("Digite um numero que corresponde a um dia da semana(1-7):");
